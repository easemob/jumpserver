...
class AliCloudRdsViewSet(ReadOnlyModelViewSet):
    filter_fields = ("instance_name", "instance_id", "connection_string", 'status', "region")
    search_fields = filter_fields
    ordering_fields = ("instance_name", "connection_string", "cpu", "memory", 'storage', 'status', 'expired_time')
