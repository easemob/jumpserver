...
from didicloud import serializers
from assets.models import Node
from common.permissions import IsOrgAdmin, IsOrgAdminOrAppUser, IsValidUser
from rest_framework.response import Response

from common.utils import get_object_or_none
from ..tasks import sync_dc2_list_info_manual
from ..models import *


class DidiCloudDc2SyncUpdate(APIView):
    permission_classes = (IsOrgAdmin,)

    def post(self, request, *args, **kwargs):
        task = sync_dc2_list_info_manual.delay()
        return Response({"task": task.id})


class DidiCloudDc2ViewSet(ReadOnlyModelViewSet):
    ...
    queryset = Dc2.objects.all()
    serializer_class = serializers.Dc2Serializer
